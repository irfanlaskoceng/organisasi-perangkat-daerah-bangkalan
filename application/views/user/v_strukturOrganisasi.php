        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-12">
                <div class="bg-white p-4 animate2 slideIn" style="border-radius: 5px;">  
                    <h4 class="text-center">Struktur Organisasi Dinas Komunikasi dan Informatika Kabupaten Bangkalan</h4> 
                    <div class="text-center mt-4 mb-4">
                        <img class="img-fluid rounded" src="<?php echo base_url().'assets/images/strukturorganisasi.jpg' ?>" alt="">
                    </div>
