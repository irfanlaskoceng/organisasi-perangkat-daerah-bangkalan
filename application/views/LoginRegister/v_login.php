            ...
            <div class="col-md-4">
                <div class="login">
                    <fieldset class="border p-2">
                        ...
                        ?>
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url().'/c_login_register/authLogin'?>">
                            ...
                            <a class="regfor" href="<?php echo site_url('c_login_register/index_forgetPasswor')?>" >forget password?</a>
                            <a class="regfor" href="<?php echo site_url('c_login_register/register')?>" >register if you don't have an account</a>
                        </form>
                    </fieldset>
                </div>
            </div>
