            ...
            <div class="col-md-4">
                <div class="login">
                    <fieldset class="border p-2">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url().'/c_login_register/updatePassword'?>">
                            <input type="hidden" name="user_key" value="<?php echo $tmpKEYuser?>"/>
