...
<head>
    ...
    <title>Organisasi Perangkat Daerah - Add Berita</title> 
...
<body>
    ...
    <div class="container">
        <ol class="breadcrumb my-3">
            ...
            <li class="breadcrumb-item active"><span style="color: white;">Add Berita</span> </li>
        </ol>

        <div class="row justify-content-md-center">
            <div class="col-sm-12">
                <div class="card mb-4 ">
                    <h5 class="card-header bg-dark text-white text-center">Add Berita</h5>
                    <div class="card-body" style="background: rgb(233, 233, 233)">
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url().'c_berita/doAddBerita'?>">
                            <div class="form-group">
                                <label for="labelName">Judul</label>
                                <input style= "height:30px; font-size: 13px;" type="text" class="form-control" name="berita_judul" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="berita_deskripsi" rows="100" class="ckeditor" id="editor1" ></textarea>
