...
<head>
    ...
    <title>Organisasi Perangkat Daerah - Add Dokumen</title> 
...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-4">
                <div class="card mb-4">
                    <h5 class="card-header bg-dark text-white text-center">Add Dokumen</h5>
                    <div class="card-body" style="background: rgb(233, 233, 233)">
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url().'c_dokumen/doAddDokumen'?>">
                            <div class="form-group">
                                <label for="labelName">Judul</label>
                                <input style= "height:30px; font-size: 13px;" type="text" class="form-control" name="dokumen_judul" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea style= "font-size: 13px;" class="form-control" id="exampleFormControlTextarea1" name="dokumen_deskripsi" rows="3"></textarea>
                                <small id="emailHelp" class="form-text text-muted ml-1">
                                <?php
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Gambar Thumbnail PDF</label>
