                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" style="background: rgb(233, 233, 233)">
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url().'c_opdGaleri'.$formAction?>">
                            <input type="hidden" name="galeri_id" value="<?php echo $tmpGaleri['IDGALERY']?>">
                            <div class="row justify-content-center">
                                <img src="<?php echo base_url().$pathIMG.$tmpGaleri['NAMAGALERY']?>" width="80" height="80" class="rounded-circle" alt="">
                            </div>
                            <div class="form-group">
                                <label for="labelName">Judul</label>
                                <input style= "height:30px; font-size: 13px;" type="text" class="form-control" name="galeri_judul" value="<?php echo $tmpGaleri['JUDULGALERY']?>" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea style= "font-size: 13px;" class="form-control" id="exampleFormControlTextarea1" name="galeri_deskripsi" rows="3"><?php echo $tmpGaleri['KETGALERY']?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    if($this->session->flashdata('messageUpGal'))
                                    {
                                        echo $this->session->flashdata("messageUpGal");
                                    }
                                ?>
                                </small>
                            </div>
